...
if not _soft then
  ...
  assert(tonumber('0x0.' .. string.rep('0', 1000) .. '74p4004') == 0x7.4)
end
...
assert(0x0p12 == 0 and 0x0.0p-3 == 0)
...
assert(0x0.FfffFFFF == 1 - '0x0.00000001')
assert('0xA.a' + 0 == 10 + 10/16)
assert(0xa.aP4 == 0XAA)
assert(0x4P-2 == 1)
assert(0x1.1 == '0x1.' + '+0x0.1')
assert(0Xabcdef.0 == 0x0.ABCDEFp+24)
